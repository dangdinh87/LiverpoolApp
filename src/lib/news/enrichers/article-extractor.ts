...
function extractVietnameseGeneric(
  ...
  // Deduplicate exact matches of the sapo in contentClone (e.g. sometimes left in h2 or p)
  if (sapoText) {
    ...
    // Prepend the sapo immediately after deduplication, outside the htmlContent flag
    contentClone.prepend(`<p class="sapo"><strong>${sapoText}</strong></p>`);
  }
