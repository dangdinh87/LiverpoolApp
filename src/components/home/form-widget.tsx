  ...
  return (
    <div className="flex flex-col gap-4 p-5 h-full">
      <div className="flex items-center justify-between">
        ...
        <span className="font-barlow text-xs text-stadium-muted">Last 5</span>
      </div>
        ...
        {last5.map((result, i) => {
          ...
          return (
            <div
              key={i}
              className={cn(
                "w-10 h-10 rounded-full flex items-center justify-center font-bebas text-white text-lg",
      ...
      {/* W/D/L summary */}
      <div className="flex justify-around border-t border-stadium-border pt-3 mt-auto">
        <div className="text-center">
          <p className="font-bebas text-2xl text-green-400">{wins}</p>
          <p className="font-barlow text-xs text-stadium-muted uppercase tracking-wider">W</p>
        </div>
        <div className="text-center">
          <p className="font-bebas text-2xl text-yellow-400">{draws}</p>
          <p className="font-barlow text-xs text-stadium-muted uppercase tracking-wider">D</p>
        </div>
        <div className="text-center">
          <p className="font-bebas text-2xl text-red-400">{losses}</p>
          <p className="font-barlow text-xs text-stadium-muted uppercase tracking-wider">L</p>
        </div>
      </div>
    </div>
  );
